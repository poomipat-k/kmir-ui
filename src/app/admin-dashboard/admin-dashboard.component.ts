...
export class AdminDashboardComponent implements OnInit, OnDestroy {
  ...
  */
  ...
  protected pageDescription =
    signal(`หน้านี้พัฒนาเพื่อการใช้งานของนักวิชาการด้านต่างประเทศ สสส. ในฐานะผู้รับผิดชอบในบทบาทหลัก 3 ส่วน ได้แก่ 
    (1) ผู้ประเมินร่วมและบันทึกกิจกรรมต่างๆในความก้าวหน้างานด้านต่างประเทศของทุกแผน
    (2) ผู้ประสานงานกับทุกแผนงานเมื่อถึงรอบการประเมินความก้าวหน้า ตามแต่ที่กำหนดร่วมกัน และ
    (3) ผู้ดูแลระบบหรือแอดมินในการให้อนุญาตแก้ไขข้อมูลต่างๆ รวมทั้งการให้คำแนะนำและแก้ไขปัญหาเบื้องต้นของการใช้งาน
    `);
